...
function App() {
  ...
  const handleRegistration = (event) => {
    ...
    if(password.length < 6){
      setError("Password will must be at least 6 characters")
      return;
    }
    if(!/(?=.*[A-Z].*[A-Z])/.test(password)){
      setError("Password will contain atleast 2 uppercase");
      return;
    }
  ...
  return (
    <div className="w-75 mx-auto">
      <form onSubmit={handleRegistration}>
        ...
        <button onClick={handleResetPassword} type="reset" className="btn btn-danger">Reset password</button>
      </form>
      <br /><br /><br />
      <div>******************************</div>
      <br /><br /><br />
